...
(`spec.md`, `tech-spec.md`, and `docs/concept/Project.md` where the unit touches
...
| what the app is, or what it deliberately does not do | `docs/concept/Project.md`, if the change moved a scope line |

### 8c. The archive row

Move this change into the **Implemented** table in
[specs/features.md](../../../specs/features.md), and strike it from
**Candidates** if it was sitting there. The file does not exist yet — the first
change through this door creates it, with an **Implemented** and a **Candidates**
table:
